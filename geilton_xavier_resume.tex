  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Main Responsibilities}
        ...
        {microservico responsible for collecting information from all azure devops projects, with the ability to identify duplicate projects and possible project owners based on information from the commit history;
