...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Faculdade UniBF}{São Paulo, Brazil}
      {Postgraduate Degree, Information Systems;}{2022 -- 2022}
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Senior Software Engineer | Software Architect (Hands-on)}{Apr 2021 - Current}
    \resumeItemListStart
